import { leadershipQualities } from "@/lib/leadership-data";

export function LeadershipQualities() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {leadershipQualities.map((quality) => (
            <div key={quality.id} className="flex flex-col items-center p-6 bg-white rounded-2xl shadow-lg border border-slate-200">
              ...
              <h3 className="text-lg font-bold text-slate-800 text-center">{quality.title}</h3>
            </div>
          ))}
        </div>
      </div>
