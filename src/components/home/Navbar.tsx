    ...
    <div className="absolute top-6 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex justify-end mb-3 lg:mb-4">
        <div className="hidden items-center gap-3 lg:flex">
          <button className="flex items-center gap-1 text-xs font-semibold text-black transition hover:text-blue-800">
            <User size={14} />
            Login / Register
          </button>
          <button className="flex items-center gap-1 text-xs font-semibold text-black">
